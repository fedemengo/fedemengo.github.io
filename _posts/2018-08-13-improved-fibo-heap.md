...
Since my old post on the [fibonacci-heap]({{site.base}}/blog/2018/01/fibonacci-heap.html) I made a few changes in the structure, cleaned the code and I had the chances to perform some other tests<!--more-->.
